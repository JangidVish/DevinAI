  ...
  >
    ...
    <div className="user-tiles mt-2 flex flex-col gap-2 flex-grow">
      {project.users?.map((u, index) => (
        <div key={u._id || index} className="tile w-full bg-indigo-300 hover:bg-indigo-400 rounded flex gap-4 items-center flex-row justify-between px-4">
        ...
        <div className="avatar p-2">
          ...
          <div className="name font-semibold text-black">{u.username || 'user@gmail.com'}</div>
            </div>

          <div className="remove collaborater px-10" onClick={() => handleRemoveCollaborator(u._id) }>
